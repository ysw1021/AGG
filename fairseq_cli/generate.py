...
def main(args):
    ...
    if args.results_path is not None:
        ...
        # x = []
        # for i in range(96):
        #     prefix = 'checkpoints/WMT14_big_agps2_0.08/checkpoint'
        #     args.path = prefix + str(i+1) + '.pt'
        #     scorer = _main(args, sys.stdout)
        #     x.append(scorer.result_string())
        #
        # with open('result_agps_big_1_96.txt', 'w') as f:
        #     for item in x:
        #         f.write("%s\n" % item)
