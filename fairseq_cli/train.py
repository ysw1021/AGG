...
def main(args, init_distributed=False):
    ...
    if trainer.args.criterion == 'cross_entropy_agg':
        itr_per_epoch = math.ceil(len(epoch_itr.frozen_batches) /
                                  (args.distributed_world_size * args.update_freq[0]))
        trainer.criterion.set_word_count(itr_per_epoch)
