...
def collate(
    ...
    input_feeding=True, need_tgt_length=None,
):
    if len(samples) == 0:
        return {}
    ...
    if need_tgt_length is not None:
        batch = {
            'id': id,
...
class LanguagePairDataset(FairseqDataset):
    ...
    def __init__(
        ...
        align_dataset=None,
        append_bos=False, eos=None, need_tgt_length=None,
    ):
        ...
        self.need_tgt_length = need_tgt_length
    ...
    def collater(self, samples):
        ...
        return collate(
            ...
            input_feeding=self.input_feeding, need_tgt_length=self.need_tgt_length,
        )
