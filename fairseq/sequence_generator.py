...
class EnsembleModel(nn.Module):
    ...
    def has_encoder(self):
        if hasattr(self.single_model, "encoder_src"):
            return hasattr(self.single_model, "encoder_src")
    ...
    def forward_encoder(self, src_tokens, src_lengths):
        if hasattr(self.single_model, "encoder_src"):
            return [model.encoder_src(src_tokens=src_tokens, src_lengths=src_lengths)
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            if self.has_encoder() or hasattr(self.single_model, "encoder_src"):
    ...
    def reorder_encoder_out(self, encoder_outs: Optional[List[EncoderOut]], new_order):
        ...
        for i, model in enumerate(self.models):
            ...
            if hasattr(self.single_model, "encoder_src"):
                new_outs.append(
                    model.encoder_src.reorder_encoder_out(encoder_outs[i], new_order)
                )
            else:
                new_outs.append(
